...
<h1 class="heading1">
    ...
    if(isset($_POST['submit-btn'])){
        ...
        $troupeappEmail = $_POST['troupeappEmail'];
        $troupeappPhone = $_POST['troupeappPhone'];
        $troupeappAddress = $_POST['troupeappAddress'];
        $troupeappMessage = $_POST['troupeappMessage'];
        $supportDocument = $_POST['supportDocument'];

        $query = "INSERT INTO troupe_application(troupeappName, troupeappEmail, troupeappPhone, troupeappAddress, troupeappMessage, supportDocument) VALUES ('$troupeappName', '$troupeappEmail', '$troupeappPhone', '$troupeappAddress', '$troupeappMessage', '$supportDocument')";
    ...
    <div class="row" id="row">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <h3>Fill up form</h3>
            <div class="inputBox">
                <input type="text" name="troupeappName" placeholder="Enter troupe name" class="box">
                <input type="email" name="troupeappEmail" placeholder="Enter troupe email" class="box">
            </div>
            <div class="inputBox">
                <input type="text" name="troupeappPhone" placeholder="Enter troupe phone number" class="box">
                <input type="text" name="troupeappAddress" placeholder="Enter your service area follow by district, state (E.g: Segamat, Johor)" class="box">
            </div>
            <textarea name="troupeappMessage" placeholder="Anything let us know..." cols="30" rows="10"></textarea>

            <h2>Support Document: <input type="file" name="supportDocument"></h2><br>
            ...
            <input type="submit" value="Submit" name="submit-btn" class="btn">
        </form>
